   ...
   return (
      <div className="center-container">
         <Card className="center-container" style={{ width: '60rem' }} border="info">
            ...
            <Card.Body>
               <Card.Subtitle class="text-muted">If you or someone you know is struggling with a mental health disorder, the below resources are helpful starting points for getting more information and finding the help you need. <em><strong>For urgent or emergency help, please contact 911.</strong></em></Card.Subtitle>
               <br></br>
